  ...
  return (
    <div className="h-85 flex items-center justify-center min-w-full px-10">
      <div className="min-w-90 md:min-w-100 xl:min-w-100 overflow-hidden  h-full flex items-center justify-center relative z-50">
        <img
          src={img2}
          className={`absolute w-90 md:min-w-100 h-full md:right-1 object-cover rounded-2xl`} loading="lazy"/>
        <input
          type="range"
          min="0"
          max="100"
        ...
        >
          <img
            src={img1}
            alt=""
            className={`absolute md:left-0 w-90 md:w-100 h-full inset-y-0 max-w-none object-cover rounded-2xl`} loading="lazy"/>
        </div>
        <div
